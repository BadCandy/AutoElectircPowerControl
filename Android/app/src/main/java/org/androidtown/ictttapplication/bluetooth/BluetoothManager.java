...
package org.androidtown.ictttapplication.bluetooth;
...
public class BluetoothManager {
    ...
    private class ConnectThread extends Thread {
        private final BluetoothSocket mmSocket; //블루투스 소켓 객체 선언
        private final BluetoothDevice mmDevice; //블루투스 디바이스 객체 선언
        ...
        public void run() {
            ...
            try {
                ...
                // 블루투스 채팅창 시작!!!
                //여기서 플래그 설정과 함께 아두이노와 통신할 내용(함수)를 조작
                BluetoothManager.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (BluetoothManager.this) {  //동기화
                mConnectThread = null;
            }

            connected(mmSocket, mmDevice); // 연결이 됬을 경우 connected()메소드 호출
        }
